...
def make_dataset(
    ...
    Args:
        ...
        policy_cfg (PreTrainedConfig | None): Optional policy config for delta timestamps.
    ...
    if isinstance(dataset_cfg.repo_id, str):
        ...
        delta_timestamps = resolve_delta_timestamps(policy_cfg, ds_meta) if policy_cfg else None
