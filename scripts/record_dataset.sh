#!/bin/bash
#===============================================================================
# S1 数据采集 + 策略推理 启动脚本 (Hybrid Writer)
#
# 封装 record_hybrid.py，使用 HybridLeRobotWriter (SharedMemory + 原生 LeRobot 编码)。
# 零拷贝 IPC，原生 video encoding 和 stats 计算。
#
# 用法:
#   bash record_hybrid.sh
#
...
# 双臂时取消下面两行注释
LEFT_LEADER_PORT="/dev/left_leader"
RIGHT_LEADER_PORT="/dev/right_leader"
# 单臂时取消下一行注释
